...
comsc::Rectangle::Rectangle(vector<string> &r) : length(r.size() > 1 ? atof(r[1].c_str()) : 0), width(r.size() > 2 ? atof(r[2].c_str()) : 0)
{

}

comsc::Rectangle& comsc::Rectangle::operator=(const Rectangle& r)
{
	Rectangle& host = *this;
	if (this != &r)
	{
